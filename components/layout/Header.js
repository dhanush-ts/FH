        ...
        <div className="flex items-center gap-6">
          ...
          <NavigationMenu className="hidden md:flex">
            <NavigationMenuList className="gap-1">
              ...
              <NavigationMenuItem>
                <NavigationMenuTrigger className="transition-all duration-200 text-md hover:bg-accent/80">Join a hackathon</NavigationMenuTrigger>
                <NavigationMenuContent>
                  <ul className="grid gap-4 p-6 w-[400px] md:w-[500px] lg:w-[600px] grid-cols-2">
                    ...
                    {/* <ListItem href="/hackathons/categories" title="Categories">
                      Find hackathons by technology or theme
                    </ListItem> */}
                  </ul>
                </NavigationMenuContent>
              </NavigationMenuItem>
              <NavigationMenuItem>
                <NavigationMenuTrigger className="transition-all duration-200 hover:bg-accent/80 text-md">Host a hackathon</NavigationMenuTrigger>
                <NavigationMenuContent>
            ...
            <SheetContent side="right" className="p-6">
              ...
              <div className="flex flex-col gap-8 py-6">
                ...
                <nav className="flex flex-col space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="pl-4 space-y-2 text-sm">
                      <Link href="/hackathons/upcoming" className="block py-1.5 transition-colors duration-200 hover:text-primary">
                        Upcoming
                      </Link>
                      <Link href="/hackathons/ongoing" className="block py-1.5 transition-colors duration-200 hover:text-primary">
                        Ongoing
                      </Link>
                      <Link href="/hackathons/past" className="block py-1.5 transition-colors duration-200 hover:text-primary">
                        Past
                      </Link>
                      {/* <Link href="/hackathons/categories" className="block py-1.5 transition-colors duration-200 hover:text-primary">
                        Categories
                      </Link> */}
                    </div>
                  </div>
                  <div className="space-y-3">
                    ...
                    <div className="pl-4 space-y-2 text-sm">
                      <Link href="/host/create" className="block py-1.5 transition-colors duration-200 hover:text-primary">
                        Create a hackathon
                      </Link>
                      <Link href="/host/resources" className="block py-1.5 transition-colors duration-200 hover:text-primary">
                        Organizer resources
                      </Link>
                      <Link href="/host/pricing" className="block py-1.5 transition-colors duration-200 hover:text-primary">
                        Pricing
                      </Link>
                    </div>
                  </div>
                ...
                <div className="flex flex-col gap-3 mt-auto">
                  ...
                  <Button 
                    asChild 
                    className="w-full rounded-full h-11 bg-gradient-to-r from-cyan-600 to-blue-600"
                  >
                    <Link href="/signup">Sign up</Link>
                  </Button>
                </div>
