      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          >
            ...
            <motion.p variants={childVariants} className="text-lg text-slate-700 mx-auto lg:mx-0">
            ...
            <motion.div variants={childVariants} className="space-y-4 flex flex-col items-center lg:items-start">
