        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            <motion.div
              ...
              className="inline-block bg-green-100 text-green-600 px-4 py-1 rounded-full font-medium text-sm mx-auto lg:mx-0"
            >
              Why Are We Here?
            </motion.div>
            ...
            <motion.p variants={childVariants} className="text-lg text-slate-700 w-full lg:my-8 mx-auto lg:mx-0">
          ...
          {isMobile && (
            <motion.div initial="hidden" animate={controls} variants={fadeIn} className="relative h-[300px]">
